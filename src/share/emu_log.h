...
#if EMU_LOG_MASTER_ENABLED && defined(MSX_LOGS)
#define MSX_LOGS_ENABLED 1
#else
#define MSX_LOGS_ENABLED 0
#endif
...
#if EMU_LOG_MASTER_ENABLED && defined(MD_BENCHMARK_LOGS)
#define MD_BENCHMARK_LOGS_ENABLED 1
#else
